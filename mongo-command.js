...
db.movies.find({rating:{$lte:8}},{trailer:0,rating:0})

db.movies.find({rating:{$lte:8}},{_id:0,name:1,rating:1})

db.movies.find({rating:{$in:[7,8]}},{_id:0,name:1,rating:1})
...
db.movies.find({rating:{$gte:8.4 , $lte:8.6}},{_id:0,name:1,rating:1})
